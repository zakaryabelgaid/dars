...
-- Seed lessons (updated with dates)
...
select 'شرح الأربعين النووية', 'الشيخ أحمد إبراهيم', 'مسجد الفاروق', id, 'الجمعة', 'بعد المغرب', 'أسبوعياً', 40, '2025-01-03', '2025-10-03', 'شرح مفصل للأحاديث التأسيسية في الفقه الإسلامي والأخلاق.' from mosques where name = 'مسجد الفاروق'
union all
select 'تفسير سورة الكهف', 'د. محمد يوسف', 'المسجد الكبير', id, 'السبت', 'بعد الفجر', 'أسبوعياً', 12, '2025-01-04', '2025-03-22', 'جلسة صباحية أسبوعية لاستكشاف معاني ودروس سورة الكهف.' from mosques where name = 'المسجد الكبير'
union all
select 'الأخلاق الإسلامية', 'الأستاذ خالد منصور', 'المسجد المركزي', id, 'الاثنين', 'بعد العشاء', 'أسبوعياً', 20, '2025-01-06', '2025-05-19', 'تعلم آداب وأخلاق النبي ﷺ وكيفية تطبيقها في حياتنا اليوم.' from mosques where name = 'المسجد المركزي'
union all
select 'فقه العبادات', 'الشيخ سلمان مالك', 'مركز النور', id, 'الأربعاء', 'قبل المغرب', 'أسبوعياً', 15, '2025-01-08', '2025-04-16', 'دليل خطوة بخطوة لأحكام الصلاة والزكاة والصيام.' from mosques where name = 'مركز النور'
union all
select 'السيرة النبوية', 'الشيخ عمر عبد الله', 'مسجد التقوى', id, 'الأحد', 'بعد العصر', 'مرتين في الأسبوع', 30, '2025-01-05', '2025-04-17', 'رحلة تاريخية عبر حياة رسول الله ﷺ.' from mosques where name = 'مسجد التقوى';
